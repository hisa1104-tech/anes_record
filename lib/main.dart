                                                    ...
                                                    Expanded(
                                                      child: DropdownButton<String>(
                                                        ...
                                                        items: [
                                                          ...
                                                          // 🌟 既存の選択肢にないカスタム部位が選ばれている場合も表示できるようにする
                                                          if (!['左前腕', '右前腕', '左手背', '右手背', '左肘', '右肘'].contains(_selectedIvSite))
                                                            _selectedIvSite,
                                                          '自由入力...', // 🌟 自由入力のトリガー
                                                    ...
                                                    Expanded(
                                                      child: DropdownButton<String>(
                                                        ...
                                                        items: [
                                                          ...
                                                          if (!['フィジオ140', 'ラクテック', 'ソルデム3A', '生理食塩水', 'ソリタT1', 'ソリタT3'].contains(_selectedFluidType))
                                                            _selectedFluidType,
                                                          '自由入力...', // 🌟 自由入力のトリガーを追加
                                                        ].map((v) => DropdownMenuItem(
                                                          value: v,
                                            ...
                                            Expanded(
                                              child: DropdownButton<String>(
                                                ...
                                                items: [
                                                  ...
                                                  'エピリド',
                                                  'キシロカイン',
                                                  // 🌟 既存の選択肢にないカスタム局麻剤が選ばれている場合も表示できるようにする
                                                  if (!['オーラ注', 'セプトカイン', 'スキャンドネスト', 'シタネスト', 'エピリド', 'キシロカイン'].contains(_selectedLaDrug))
                                                    _selectedLaDrug,
                                                  '自由入力...', // 🌟 自由入力のトリガー
                                                ].map((v) => DropdownMenuItem(
                                                  value: v,
